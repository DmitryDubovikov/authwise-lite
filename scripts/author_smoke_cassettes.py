...
# aw-lite: smoke-набор остаётся авторским (usage синтетический, messages отсутствуют);
# базовая пачка записана реальным record в iter 1 (cassettes/base/). Формат — боевой:
# usage хранится, per-node cost в iter 3–4 считается.
