...
В Docker — только серверы наблюдаемости/реестра (сейчас MLflow, дальше Langfuse/Phoenix/
Prometheus/Grafana). Приложение, тесты, CI-гейты — на хосте через `uv run`. Контейнеры
